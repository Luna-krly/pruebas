<%-- 
    Document   : CmbPass.jsp
    Created on : 7 may 2024, 14:46:19
    Author     : Lezly Oliván
--%>
...
String id_usuario = (String) request.getAttribute("info_usuario");
                ...
                <div class="container-fluid h-custom">
                    <div class="row d-flex justify-content-center align-items-center h-100">
                        <div class="col-md-9 col-lg-6 col-xl-5">
                            <img src="<%= cambioClave %>" class="img-fluid"
                                 alt="Sample image">
                        </div>
                        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 text-center">
                            ...
                            <p class="fw-bold stc small mb-3 mt-1" style="color: #C82626;">
                                SU CLAVE HA CADUCADO, FAVOR DE CAMBIARLA
                            </p>
                            <br>
                            <input type="text" style="font-weight: bold;" class="form-control" id="txtUsuarioCambio" name="txtUsuarioCambio" placeholder="Usuario" required value="<%=id_usuario%>" hidden>
                            <input type="text" style="font-weight: bold;" class="form-control" id="botonn" name="boton" value="cambio_clave" placeholder="Contraseña" hidden>
                            <!-- Pss input -->
                            ...
                            <!-- CPss input -->
                            <div class="form-floating stc fontcontenido">
                                <input type="password" class="form-control" id="password" name="txtPassword" placeholder="CONTRASEÑA" required="">
                                <label for="floatingPassword">CONFIRME SU NUEVA CONTRASEÑA</label>
                            </div>
                            <div class="divider d-flex align-items-center my-4"></div>
                            <div class="text-center text-lg-start mt-4 pt-2 stc">
                                <button type="submit" id="boton123" name="boton123" value="cambio_clave" class="btn btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem; background-color: #FF5000; color: white;" onclick="vrfCnt(event)">
                                    CAMBIAR CONTRASEÑA
                                </button>
                                <br>
                                <br>
