<%-- 
    Document   : reporte_memorandum_lista_arrendamiento
    Created on : 2 sept 2024, 15:51:16
...
<%! obj_MArrendamiento memorandum;%>
<%! List<obj_MArrendamiento> memorandumLista;%>

<%      
try {
    memorandumLista = (List<obj_MArrendamiento>) request.getAttribute("listaMemorandum");
    ...
    JasperCompileManager.compileReportToFile("C:\\FacturasReportes\\FORMATOS FACTURACIÓN\\ReportMemoArren.jrxml");
    
    // Llena el reporte con datos y parámetros
    JasperPrint jasperPrint = JasperFillManager.fillReport("C:\\FacturasReportes\\FORMATOS FACTURACIÓN\\ReportMemoArren.jasper", null, dataSource);
    
    // Configura el tipo de contenido de la respuesta
    response.setContentType("application/PDF");
    response.setHeader("Content-Disposition", "inline; filename=\"ReporteMemorándumArrendamiento.pdf\"");
