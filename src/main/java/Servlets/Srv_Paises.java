 ...
 */
@WebServlet("/Srv_Paises")
public class Srv_Paises extends HttpServlet implements Servlet {
//--------------------------INICIA----
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("--------------------Ingresa a Srv_Paises---------------------");
        ...
        String clave = request.getParameter("clavePais");
        String desc = request.getParameter("descripcionPais");

        //Muestra lo que toma de formulario
        System.out.println("---------------------Srv_Paises---------------------");
        ...
        if (act == null) {
            ...
            System.out.println("Srv_Paises- Ningun boton- Ingresa a TRY");
            try {
                System.out.println("Srv_Paises-Lista servlet- Ingresa a TRY");
                dao3 = new dao_Pais();
                paislista = dao3.Listar();
                request.setAttribute("paislista", paislista);
                System.out.println("Srv_Paises-Lista servlet- Envia lista");
            ...
            request.getRequestDispatcher("CatalogosSat/Paises.jsp").forward(request, response);
            return;
            ...
            try {
                ...
                pais.setClavePais(clave);
                pais.setDescripcionPais(desc);
                pais.setUsuario(usuario.getUsuario());//Nombre usuario

                mensaje = call.ctg_pais(act, pais, id);
                session.setAttribute("mensaje", mensaje);

                dao3 = new dao_Pais();
                paislista = dao3.Listar();
                session.setAttribute("paislista", paislista);

                response.sendRedirect("Srv_Paises");
                return;
